...
#SELFBOT-BY:MAX
#cl = LineClient()
cl = LineClient(authToken='EzlimSU48VWFhDZfzTOc.Uv/0YYcEoAwu5rWj4Sx9Ja.76awAWywQ3Wm8BKsw+6GSHjbat1Ldwsg6Hse5vYH2R0=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ko = LineClient()
ko = LineClient(authToken='EzQfDHcR5u78nvBL69Jf.XzmbAwonn5keEY4vw/uKlW.dRbjHH3Gpffd2EMQCXBEDhz8kd5BhGHUlCiYr+XRnLM=')
ko.log("Auth Token : " + str(ko.authToken))
channel1 = LineChannel(ko)
ko.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EzsouIlqOiDjKAS2N7e0.9T/PGPFdadrWbCl3Gzx/Ga.Lpque6IDGJKDcG42Ce1zpRZVCNmkLjvjN6Vy6Q7VxXE=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='EzRmNfRMY5wGyD6Ov6fd.tLlReCirgG96uB+Q5pwO+q.2H8qqx8Lkf+kkZ+6BRa3myg8O3omgzHEuNymqFP1cYg=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#ke = LineClient()
ke = LineClient(authToken='EzlBLrqAU0NMtI6Yhie1.lXZ4ob/KwrCUJfHRJ603qq.oRdUyzXVL0seW08bSNJmc2dJ5vtD4v7obCLIhfw6wKg=')
ke.log("Auth Token : " + str(ke.authToken))
channel4 = LineChannel(ke)
ke.log("Channel Access Token : " + str(channel4.channelAccessToken))

#kf = LineClient()
kf = LineClient(authToken='EzbzYZpAY9si336sPX86.BaiKNxR2VN7zWCBrQS6P5G.tJnreoEm3L33MLux76qeNYBQpUmPOZyRa0Mi30imYeY=')
kf.log("Auth Token : " + str(kf.authToken))
channel5 = LineChannel(kf)
kf.log("Channel Access Token : " + str(channel5.channelAccessToken))

#kg = LineClient()
kg = LineClient(authToken='EzD1CHx8oQUhNSKX0VFa.UHbbg4pHBjT5VwCYtXmXsG.5VDzs0mhlviNmRrt+HSuG9+fRNTqwsgUFmaSJPyRf9w=')
kg.log("Auth Token : " + str(kg.authToken))
channel6 = LineChannel(kg)
kg.log("Channel Access Token : " + str(channel6.channelAccessToken))

#kh = LineClient()
kh = LineClient(authToken='Ez6Q3Q7EN8RSZ0b7nDHa.Oyj1ZAWaMt3CKaVDd5BW2G.Wj4wD5bDBl1SBGJe+F/DCoiP4g7HIOhWTStnR4cWYMA=')
kh.log("Auth Token : " + str(kh.authToken))
channel7 = LineChannel(kh)
kh.log("Channel Access Token : " + str(channel7.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EzKqgyd08WOX6luqZHH4.UFxlUs4U2EOQjGvMmvWMDa.JlHIITF/iFUxCLpxyFarYO7lGiNIfzvSWSpJTnlpOsE=')
ki.log("Auth Token : " + str(ki.authToken))
channel8 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel8.channelAccessToken))

#kj = LineClient()
kj = LineClient(authToken='EzrWhVPB4nD1N1HsSdl4.9UGdRKZXRTi7Enfms1+LPa.YuRTeVNcboLrB9EwyXJSBv1pKD4JHvCVcn1BwtSGObE=')
kj.log("Auth Token : " + str(kj.authToken))
channel9 = LineChannel(kj)
kj.log("Channel Access Token : " + str(channel9.channelAccessToken))

#kl = LineClient()
kl = LineClient(authToken='EzrWhVPB4nD1N1HsSdl4.9UGdRKZXRTi7Enfms1+LPa.YuRTeVNcboLrB9EwyXJSBv1pKD4JHvCVcn1BwtSGObE=')
...
wait = {
    ...
    "selfbot":True,
    "mention":"masuk ka",
    "Respontag":"yang tag, kurang desah",
                        ...
                        if cmd == "self on":
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "â§FunkZher Fams Grup Info\n"
                                ret_ += "\nâ§Nama Group : {}".format(G.name)
                                ret_ += "\nâ§ID Group : {}".format(G.id)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"â§FunkZher  bot\n\n"+ma+"\nTotalã%sã Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "â§FunkZher Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
